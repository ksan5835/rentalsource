(function($){		  
    ...
    $.extend({
        usernotify: function(options, duration) {
			var
			...
			wrapper.append(
				create_element('div', 'notify_top').append(
					...
					north = create_element('div', "usernotify_n"),
					create_element('div', "usernotify_ne")
				),
				create_element('div', 'usernotify_center').append(
				   east = create_element('div', "usernotify_nw"),
					content = create_element('div', 'usernotify_content').append(clone),
					west = create_element('div', "usernotify_e")
				),
				create_element('div', 'usernotify_bottom').append(
					create_element('div', "usernotify_se"),
					south = create_element('div', "usernotify_s"),
					create_element('div', "usernotify_sw")
				)
			);
